...
$(function(){var a=!1;$(".cpf_cnpj").keypress(function(){var e=$(this);a&&clearTimeout(a),a=setTimeout(function(){e.removeClass("validoCPF"),e.removeClass("invalidoCPF");var a=e.val(),i=valida_cpf_cnpj(a);i?e.addClass("validoCPF"):(e.addClass("invalidoCPF"),console.log("Informe Corretamente CPF/CNPJ"))},500)})});$(function(){$(".cpf_cnpj").blur(function(){var a=$(this).val();formata_cpf_cnpj(a)?$(this).val(formata_cpf_cnpj(a)):console.log("CPF ou CNPJ inválido!")})});